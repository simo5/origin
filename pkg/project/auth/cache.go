...
func NewAuthorizationCache(namespaces cache.SharedIndexInformer, reviewer Reviewer,
	clusterRoleLister SyncedClusterRoleLister, clusterRoleBindingLister SyncedClusterRoleBindingLister,
	roleNamespacer SyncedRoleLister, roleBindingNamespacer SyncedRoleBindingLister,
) *AuthorizationCache {
	ac := &AuthorizationCache{
		...
		roleNamespacer:                roleNamespacer,
		roleBindingNamespacer:         roleBindingNamespacer,
		roleLastSyncResourceVersioner: unionLastSyncResourceVersioner{clusterRoleLister, clusterRoleBindingLister, roleNamespacer, roleBindingNamespacer},
